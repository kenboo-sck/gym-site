        ...
        <div className="pt-32 pb-20 font-[family-name:var(--font-oswald)]">
            ...
            <section className="max-w-7xl mx-auto px-6 mt-24">
                <div className="flex flex-col md:flex-row-reverse gap-12 items-start">
                    ...
                    <div className="w-full md:w-1/2 space-y-10">
                        <div>
                            <h2 className="text-4xl font-black italic uppercase text-gray-900 mb-2">速水 堅太</h2>
                            <div className="flex flex-wrap gap-3">
                                <span className="bg-black text-white px-4 py-1 text-xs font-bold italic uppercase tracking-widest">
                                    キックボクシング / ムエタイ
                                </span>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-50 p-8 border border-gray-100 shadow-sm">
                                ...
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">経歴・実績</p>
                                <ul className="space-y-4 font-sans text-gray-700">
                                    <li className="flex items-start gap-3">
                                        <span className="text-orange-600 font-bold">●</span>
                                        <div>
                                            <p className="font-bold">格闘技歴：キックボクシング/ムエタイ 10年</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="text-orange-600 font-bold">●</span>
                                        <div>
                                            <p className="font-bold">プロ戦績：3勝5敗</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
